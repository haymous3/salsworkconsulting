...
//     {
//       img: <CheckIcon className="text-primary mx-auto w-[60px] h-[60px]" />,
//       heading: "Expertise",
...
//   ];
//   return (
//     <div className="flex mt-60 justify-between px-30">
//       <div className="">
...
//             <div key={i} className="flex gap-6 mt-8">
//               {chooseUs.img}
//               <div>
//                 <h2 className="font-semibold font-3xl">{chooseUs.heading}</h2>
//                 <p className="text-justify text-[#666666] w-[60%] leading-7">
//                   {chooseUs.text}
//                 </p>
//               </div>
//             </div>
...
//           placeholder="blur"
//           quality={70}
//           className="w-full relative -top-10 left-6"
//           alt="Team image"
//         />
//         <Image
//           src={ChooseUs2}
//           placeholder="blur"
//           quality={70}
//           className="w-full relative -top-150 right-60"
//           alt="Team image"
//         />
//       </div>
//     </div>
...
const ChooseUs = () => {
  ...
  return (
    <div className="flex flex-wrap mt-40 justify-between px-24 items-center gap-12">
      ...
      <div className="relative flex-1 min-w-[300px] flex justify-center items-center">
        <motion.div
